        ...
        <div>
            ...
            setOpenModal={setOpenModal}
                ...
                body={
                    ...
                    <PrimaryButton title="View Refund Status" to="/user/return-refund" className={`py-2.5 px-10 w-fit mx-auto mt-5 text-base ${selected === "makeup" ? 'bg-mColor3/80 text-blackCustom' : 'bg-sColor6 text-whiteCustom'}`} />
                </div>
                }
            />
        </div>
